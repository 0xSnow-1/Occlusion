...
- Before you finish, check that every sentence ends with a valid [SRC:doc_id] copied from the context. Remove any sentence that does not, then write your answer from what remains
</instructions>
...
<example>
### Example 3 — the boundary question, answered confidently
