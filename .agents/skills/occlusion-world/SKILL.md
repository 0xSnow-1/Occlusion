...
- No golden set exists yet (`src/eval/` is an empty stub; TODO Phase 2 unbuilt). Until it lands, focal questions live per-Task in `environment/questions.jsonl` (text only, no expected results). Frozen retrieval snapshot: `evals/guardrails/tasks/live-model-refusal/environment/chunks_v1.jsonl` (120 chunks, post-2026-09-08 full re-ingest).
